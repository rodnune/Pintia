            ...
            <div id="content-edit" style="margin-top:20px;">
                <div class="post">
                    ...
                    <table class="table table-hover table-bordered" rules="all">
                        ...
                        {{Form::open(array('action' => 'TumbasController@marcar_pendiente','method' => 'post'))}}
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="center"><br>
                                ...
                                <br><br>
                                {{Form::open(array('action' => 'TumbasController@marcar_completado','method' => 'post'))}}
                                <input type="hidden" name="id" value='{{$tumba->IdTumba}}'>
...
<script>
    $('#modal-ayuda').find('.modal-body').load('/html/tumbas/pendientes.html');
</script>