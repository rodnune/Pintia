            ...
            <div class="post">
                ...
                <table class="table table-hover table-bordered" rules="none">
                    <tbody>
                        ...
                        <tr>
                            <td class="info" colspan="4" align="center"><h3>Componentes Geol&oacute;gicos</h3></td>
                        </tr>
                            ...
                            <tr>
                              <td colspan="2" align="center">
                                  ...
                                  {{Form::open(array('action' => "CGeologicosController@asociarUE", 'method' => 'post'))}}
                                  ...
                                  @foreach($no_asociados as $no_asociado)
                                      <option value="{{$no_asociado->IdCGeologico}}">{{$no_asociado->Denominacion}}</option>
                                      @endforeach
                                ...
                                <td colspan="2" align="center">
                                    ...
                                    <input type="hidden" name="id" value="{{$ud_estratigrafica->UE}}">
                                    <select class="form-control" name="id_geo_delete" size="10" style="width:100%">


                                        @foreach($asociados as $asociado)
                                        <option value="{{$asociado->IdCGeologico}}">{{$asociado->Denominacion}}</option>
                                        @endforeach
