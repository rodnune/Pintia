            ...
            <div id="content-edit" style="margin-top:0px">
                <div class="post">
                    ...
                    <table class="table table-bordered table-hover" rules="all">
                        <tbody><tr>
                            <td><strong>Seleccionar componente artificial:</strong></td>
                            <th  align="center" colspan="2">
                                {{Form::open(array('action' => 'CArtificialesController@gestionar','method' => 'post'))}}
...
<script>
    $('#modal-ayuda').find('.modal-body').load('/html/listas/artificiales.html');
</script>
