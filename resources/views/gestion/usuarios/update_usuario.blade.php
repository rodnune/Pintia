            ...
            <div id="content-wide" style="margin-top:20px;">
                <div class="post">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        {{Form::open(array('action' => 'UsuariosController@update','method' => 'post'))}}
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endphp
                                    <select class="form-control" name="admin_level" style="width:100%">


                                        @foreach($tipos_usuario as $key => $user)
                                            @if($usuario->admin_level == $key)
                            ...
                            <td><input class="form-control" type="email" name="email" id="email" style="width:100%" maxlength="50" value="{{$usuario->email}}" required/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="first_name" id="first_name" style="width:100%" maxlength="20" value="{{$usuario->first_name}}" required/>
                            </td>

                            <td><strong><label for="last_name">Apellidos:</label></strong></td>
                            <td><input class="form-control" type="text" name="last_name" id="last_name" style="width:100%" maxlength="20" value="{{$usuario->last_name}}" required/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="city" id="city" style="width:100%" value="{{$usuario->city}}" maxlength="20"/></td>
                            ...
                            <td colspan="3">
                                ...
                                <select class="form-control" name="hobbies[]" id="hobbies" style="width:100%" size="10" multiple="multiple">
                                    @foreach( Config::get('enums.hobbies') as $hobby )
                                        ...
                                        @if( in_array($hobby, $usuario->hobbies) )
                    ...
                    <br/>
                    <center>
                        <button type="submit" name="submit" class="btn btn-primary"><i class="fa fa-check"></i> Actualizar</button>
